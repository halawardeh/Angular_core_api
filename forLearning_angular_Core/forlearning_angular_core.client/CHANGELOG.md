...
- Create Angular project with ng: `ng new forlearning_angular_core.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`forlearning_angular_core.client.esproj`).
